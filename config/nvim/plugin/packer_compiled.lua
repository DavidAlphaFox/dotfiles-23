...
_G.packer_plugins = {
  ...
  ["cinnamon.nvim"] = {
    config = { "\27LJ\2\nn\0\0\3\0\4\0\a6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\3\0B\0\2\1K\0\1\0\1\0\3\18default_delay\3\3\21extended_keymaps\2\18extra_keymaps\2\nsetup\rcinnamon\frequire\0" },
    loaded = true,
  ...
  ["nvim-treesitter"] = {
    after = { "lualine.nvim", "nvim-yati", "nvim-treesitter-endwise", "nvim-treesitter-textobjects", "nvim-ts-autotag", "nvim-ts-rainbow", "nvim-ts-context-commentstring" },
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'coq_nvim', 'lualine.nvim', 'nvim-lspconfig'}, { event = "VimEnter *" }, _G.packer_plugins)]]
