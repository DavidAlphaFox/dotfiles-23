...
_G.packer_plugins = {
  ...
  ["lsp-colors.nvim"] = {
    config = { "\27LJ\2\n~\0\0\3\0\4\0\a6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\3\0B\0\2\1K\0\1\0\1\0\4\fWarning\f#ffda45\nError\f#f34f4d\tHint\f#7ad88e\16Information\f#8accfe\nsetup\15lsp-colors\frequire\0" },
    loaded = true,
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-textobjects", "nvim-ts-context-commentstring", "nvim-ts-rainbow", "nvim-yati", "lualine.nvim" },
