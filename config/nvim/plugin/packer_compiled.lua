...
_G.packer_plugins = {
  ...
  ["nvim-lspconfig"] = {
    after = { "null-ls.nvim", "lua-dev.nvim", "fidget.nvim" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-endwise", "nvim-treesitter-textobjects", "nvim-yati", "nvim-ts-rainbow", "nvim-ts-context-commentstring", "lualine.nvim", "nvim-ts-autotag" },
...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'nvim-colorizer.lua', 'gitsigns.nvim', 'nvim-lspconfig'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'coq_nvim', 'nvim-notify', 'lualine.nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
