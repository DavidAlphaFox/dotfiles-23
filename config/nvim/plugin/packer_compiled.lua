...
_G.packer_plugins = {
  ...
  ["lsp-colors.nvim"] = {
    config = { "\27LJ\2\n~\0\0\3\0\4\0\a6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\3\0B\0\2\1K\0\1\0\1\0\4\16Information\f#8accfe\nError\f#f34f4d\fWarning\f#ffda45\tHint\f#7ad88e\nsetup\15lsp-colors\frequire\0" },
    loaded = true,
  ...
  ["nvim-treesitter"] = {
    after = { "lualine.nvim", "nvim-yati", "nvim-treesitter-textobjects", "nvim-ts-context-commentstring", "nvim-ts-rainbow" },
