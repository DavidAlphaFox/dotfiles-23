...
function M.setup()
  ...
  utils.map("n", "ñdw", "<cmd>TroubleToggle workspace_diagnostics<cr>", { desc = "Workspace Diagnostics" })
  utils.map("n", "ñdd", "<cmd>TroubleToggle document_diagnostics<cr>", { desc = "Show Diagnostics" })
